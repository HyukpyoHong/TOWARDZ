function [Solution,Index, cum_num_cand, cum_num_trans_WR,cum_num_trans_DZ,cum_num_trans_WR_DZ] = CRN_translation_naive(sources, products, max_order, cum_num_cand,cum_num_trans_WR,cum_num_trans_DZ,cum_num_trans_WR_DZ)
if nargin == 2
    max_order = 2;
end
...
% cum_num_cand = cum_num_cand + number_of_comb;
...
for ii = 1:min(number_of_comb, 10^9)
